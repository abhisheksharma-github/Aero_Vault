...
export default function CountryExplorerView({ onSelectCountry, onSelectAircraft }) {
  ...
  return (
    <div className="space-y-8 animate-fade-in text-slate-100">
      {/* Header Banner */}
      <div className="relative rounded-3xl p-6 sm:p-10 overflow-hidden border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-950 to-cyan-950/40 shadow-2xl">
        ...
        <div className="relative z-10 max-w-4xl space-y-4">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-xl text-xs font-mono font-bold tracking-wider uppercase bg-cyan-500/10 text-cyan-400 border border-cyan-500/30">
          ...
          <p className="text-sm sm:text-base text-slate-400 leading-relaxed font-sans max-w-3xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-6 border-t border-slate-800/80">
          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
            <div className="text-[11px] font-mono text-slate-400 uppercase">Sovereign Nations</div>
            <div className="text-2xl font-black font-display text-white mt-1">19 + EU</div>
            <div className="text-[10px] font-mono text-cyan-400">100% G20 Coverage</div>
          </div>

          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
            <div className="text-[11px] font-mono text-slate-400 uppercase">Tracked Fleet Estimate</div>
            <div className="text-2xl font-black font-display text-emerald-400 mt-1">
              {totalFleetEstimate.toLocaleString()}+
            </div>
            <div className="text-[10px] font-mono text-slate-400">Active Defense Airframes</div>
          </div>

          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
            <div className="text-[11px] font-mono text-slate-400 uppercase">Air & Naval Branches</div>
            <div className="text-2xl font-black font-display text-cyan-400 mt-1">
              {totalBranchesCount} Arms
            </div>
            <div className="text-[10px] font-mono text-slate-400">Air Force, Navy, Army Avn</div>
          </div>

          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80">
            <div className="text-[11px] font-mono text-slate-400 uppercase">Data Confidence</div>
            <div className="text-2xl font-black font-display text-purple-400 mt-1">TIER 1-2</div>
            <div className="text-[10px] font-mono text-emerald-400">OSINT / MoD Verified</div>
          </div>
        </div>
      </div>

      {/* PHASE 1 SPOTLIGHT: INDIA (PRIMARY COUNTRY) */}
      <div className="p-6 sm:p-8 rounded-3xl border border-orange-500/30 bg-gradient-to-r from-orange-950/30 via-slate-900 to-emerald-950/30 shadow-2xl relative overflow-hidden">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="flex items-center space-x-2">
                  <span className="text-xs font-mono font-bold uppercase tracking-wider text-orange-400 bg-orange-500/10 px-2.5 py-0.5 rounded-md border border-orange-500/30">
                    Phase 1 Primary Spotlight
                  </span>
                  <span className="text-xs font-mono text-slate-400">IND • ISO: IN</span>
                </div>
                <h3 className="text-2xl font-display font-black text-white">Republic of India Defense Aviation</h3>
              </div>
            </div>
          ...
          <div className="flex items-center space-x-3 flex-shrink-0">
            <button
              ...
              className="px-5 py-3 rounded-2xl bg-orange-500/20 hover:bg-orange-500/30 border border-orange-500/40 text-orange-300 text-xs font-mono font-bold transition-all shadow-lg flex items-center space-x-2"
            >
            ...
            <button
              ...
              className="px-5 py-3 rounded-2xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 text-xs font-mono font-black transition-all shadow-glow-cyan flex items-center space-x-2"
            >
